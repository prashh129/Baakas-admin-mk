...
import 'package:baakas_admin/common/widgets/containers/circular_container.dart';
          ...
          child:
              loading
                  ? const BaakasCircularContainer(
                    width: BaakasSizes.xl,
                    height: BaakasSizes.xl,
                  ...
                  : BaakasCircularIcon(
                    ...
                    backgroundColor: BaakasColors.primary.withOpacity(0.9),
                  ),
        ),
      ],
    );

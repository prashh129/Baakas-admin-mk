...
class BaakasSiteTemplate extends StatelessWidget {
  const BaakasSiteTemplate({super.key, this.desktop, this.tablet, this.mobile, this.useLayout = true});

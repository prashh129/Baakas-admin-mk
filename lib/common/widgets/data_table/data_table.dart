...
class BaakasDataTable extends StatelessWidget {
  const BaakasDataTable({
    super.key,
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: DataTable2(
        ...
        headingRowColor:
            WidgetStateProperty.resolveWith((states) => BaakasColors.primary),
        // Set the decoration for the data table
        decoration: const BoxDecoration(
          color: Colors.white,
          borderRadius:
              BorderRadius.all(Radius.circular(BaakasSizes.borderRadiusMd)),
        ),

...
import '../../../../controllers/seller/create_seller_controller.dart';
import '../../../../controllers/category/category_controller.dart';

class CreateSellerForm extends StatelessWidget {
  const CreateSellerForm({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(CreateSellerController());
                    ...
                    controller.loading.value
                        ...
                        : SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () => controller.createSeller(),

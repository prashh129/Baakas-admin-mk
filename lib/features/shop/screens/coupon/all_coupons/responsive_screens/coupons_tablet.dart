...
class CouponsTabletScreen extends StatefulWidget {
  const CouponsTabletScreen({super.key});

  @override
  State<CouponsTabletScreen> createState() => _CouponsTabletScreenState();
}

class _CouponsTabletScreenState extends State<CouponsTabletScreen> {

...
class CouponsDesktopScreen extends StatefulWidget {
  const CouponsDesktopScreen({super.key});

  @override
  State<CouponsDesktopScreen> createState() => _CouponsDesktopScreenState();
}

class _CouponsDesktopScreenState extends State<CouponsDesktopScreen> {
